...
public class MVCBoradDAO extends JDBConnection {
    ...
    public int updateEdit(BoardDTO dto) { // 동하
        int result = 0;
    ...
    public int insertWrite(BoardDTO dto) { // 아현
    	int result = 0;
    ...
    public BoardDTO selectView(String num) { // 명진
    ...
    public List<BoardDTO> selectList(Map<String, Object> param) { // 동영
    ...
    public List<BoardDTO> selectListPage(Map<String, Object> param) { // 동영
        List<BoardDTO> boardList = new ArrayList<>();
